...
if __name__ == "__main__":
    ...
    print("ESECUZIONE 2")
    partial_result2 = Toprank(G, k)
    for i, (vertex, avg_distance) in enumerate(partial_result2, start=1):
        print(f"v{i}: Nodo originale: {vertex}, Distanza media esatta: {avg_distance}")

    print("ESECUZIONE 3")
    partial_result3 = Toprank(G, k)
    for i, (vertex, avg_distance) in enumerate(partial_result3, start=1):
        print(f"v{i}: Nodo originale: {vertex}, Distanza media esatta: {avg_distance}")
